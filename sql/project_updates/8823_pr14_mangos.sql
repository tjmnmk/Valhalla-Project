-- AN HC
DELETE FROM `creature_onkill_reputation` WHERE creature_id IN (31612,31611,31610,31585,31586,31587,31588,31589,31590,31591,31592,31593,31594,3​1595,31596,31597,31598,31599,31600,31601,31602,31603,31604,31605,31606,31607,316​08,31609,31647,31613,31614,31615,31616,31617);
